      ...
      <div className="container mx-auto px-4 py-8 pb-32">
        {!connected ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-center">
            <div className="w-24 h-24 rounded-full bg-[var(--bg-dark)] border border-white/5 flex items-center justify-center mb-6">
              <svg
                ...
                strokeWidth={1.2}
                stroke="currentColor"
                className="w-12 h-12 text-[var(--gold-main)]"
              >
                <path
                  strokeLinecap="round"
            ...
            <p className="text-[var(--text-secondary)] mb-8 max-w-md">
              Connect a Solana wallet to browse tables, create new games, and
              join the action.
            </p>
            <WalletButton className="btn-gold !text-base !px-10 !py-3 !rounded-xl !font-bold" />
          </div>
        ) : (
          /* Connected - lobby content */
          <>
            {/* Title area */}
